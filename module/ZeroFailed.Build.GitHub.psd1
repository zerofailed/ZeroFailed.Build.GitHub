...
RootModule = 'ZeroFailed.Build.GitHub.psm1'
...
GUID = 'de7e0501-9eac-4286-8788-39affdb33d88'
...
Description = 'An extension for ZeroFailed with build-related features for GitHub integration'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/zerofailed/ZeroFailed.Build.GitHub/blob/main/LICENSE'
